  ...
  !(function (a) {
              ...
              for (var e, f, g = a(this[0]); g.length && g[0] !== c; ) {
                if (
                  ...
                  ("absolute" === e || "relative" === e || "fixed" === e) &&
                    ((f = parseInt(g.css("zIndex"), 10)), !isNaN(f) && 0 !== f))
                )
                  return f;
                g = g.parent();
              }
    ...
    (function (a, b) {
      ...
      a.extend(a.mobile, {
        ...
        getClosestBaseUrl: function (b) {
          ...
          return (
            (a.mobile.dynamicBaseEnabled && c && a.mobile.path.isPath(c)) ||
              (c = d),
        ...
        removeActiveLinkClass: function (b) {
          !a.mobile.activeClickedLink ||
            (a.mobile.activeClickedLink.closest("." + a.mobile.activePageClass)
              .length &&
              !b) ||
            a.mobile.activeClickedLink.removeClass(a.mobile.activeBtnClass),
            (a.mobile.activeClickedLink = null);
        },
        getInheritedTheme: function (a, b) {
          for (
            var c, d, e = a[0], f = "", g = /ui-(bar|body|overlay)-([a-z])\b/;
            e &&
            ((c = e.className || ""), !(c && (d = g.exec(c)) && (f = d[2])));
    ...
    (function (a, b) {
      ...
      (a.cleanData = function (b) {
        ...
        (a.Widget.prototype = {
          ...
          option: function (c, d) {
            ...
            if ("string" == typeof c)
              if (((h = {}), (e = c.split(".")), (c = e.shift()), e.length)) {
                for (
                  f = h[c] = a.widget.extend({}, this.options[c]), g = 0;
                  g < e.length - 1;
                  g++
                )
                  (f[e[g]] = f[e[g]] || {}), (f = f[e[g]]);
          ...
          _off: function (a, b) {
            (b =
              (b || "").split(" ").join(this.eventNamespace + " ") +
              this.eventNamespace),
    ...
    (function (a) {
      ...
      a.widget("mobile.loader", {
        ...
        show: function (d, e, f) {
          ...
          this.resetHtml(),
            "object" === a.type(d)
              ? ((i = a.extend({}, this.options, d)), (d = i.theme))
                ...
                (i.start = function () {
                  ...
                  (m = function (c, d) {
                    ...
                    c !== d &&
                      ...
                      e.open(),
                      f &&
                        e.write('<script>document.domain="' + f + '"</script>'),
                      e.close(),
                      (b.location.hash = c));
                  });
              })(),
        ...
        (a.event.special.navigate = c = {
          ...
          hashchange: function (b) {
            ...
            (e.originalEvent = b),
              ...
              e.isDefaultPrevented() ||
                ((c.originalEvent = b),
                d.trigger(c, { state: b.hashchangeState || {} }));
          },
          setup: function () {
            c.bound ||
              ((c.bound = !0),
    ...
    (function (a, c) {
      ...
      (a.mobile.path = d = {
        ...
        convertUrlToDataUrl: function (a) {
          ...
          return (
            d.isEmbeddedPage(e)
              ? (c = e.hash.split(f)[0].replace(/^#/, "").replace(/\?.*$/, ""))
          ...
          return (
            ...
            i
              ? ((d.isPath(k) ||
                ...
                -1 === k.indexOf("#") && "" !== k && (k = "#" + k),
                (c = d.parseUrl(c)),
                (c = c.protocol + c.doubleSlash + c.host + c.pathname + f + k))
              : (c += c.indexOf("#") > -1 ? l : "#" + l),
            c
          );
        },
        ...
        isFirstPageUrl: function (b) {
          ...
          return (
            f &&
            (!e.hash || "#" === e.hash || (h && e.hash.replace(/^#/, "") === h))
          );
        },
        ...
        (d.documentBase = e.length
          ? d.parseUrl(d.makeUrlAbsolute(e.attr("href"), d.documentUrl.href))
          : d.documentUrl),
        ...
        a.extend(a.mobile.History.prototype, {
          ...
          direct: function (c) {
            var d = this.closest(c.url),
              e = this.activeIndex;
            d !== b && ((this.activeIndex = d), (this.previousIndex = e)),
              e > d
                ? (c.present || c.back || a.noop)(this.getActive(), "back")
                : d > e
                ? (c.present || c.forward || a.noop)(
                    this.getActive(),
                    "forward"
                  )
                : d === b && c.missing && c.missing(this.getActive());
          },
        });
    })(a),
    (function (a) {
          ...
          go: function (e, f, g) {
            ...
            (i = d.squash(e)),
              ...
              l &&
                ...
                (k.originalEvent = { type: "popstate", state: null }),
                this.squash(e, h),
      ...
      a.each(["animation", "transition"], function (c, g) {
        ...
        (a.fn.animationComplete = function (e, f, g) {
          ...
          return (a.support.cssTransitions && "transition" === l) ||
            ...
            ? (g === b &&
                (a(this).context !== c &&
                  (i = 3e3 * parseFloat(a(this).css(d[l].duration))),
                (0 === i || i === b || isNaN(i)) &&
          ...
          o("vmouseup", a, d),
            J ||
              ...
              b &&
                ...
                K.push({ touchID: Q, x: c.clientX, y: c.clientY }),
                (L = !0))),
            o("vmouseout", a, d),
            (J = !1),
            m();
                ...
                if (!a.event.special.swipe.eventInProgress) {
                  ...
                  (e.move = function (b) {
                    g &&
                      ...
                      i ||
                        ((i = a.event.special.swipe.handleSwipe(g, d, c, h)),
        ...
        c = {
          ...
          set: function (b) {
            a.mobile.dynamicBaseEnabled &&
              ...
              c.element.attr(
                "href",
                a.mobile.path.makeUrlAbsolute(b, a.mobile.path.documentBase)
              );
          },
          rewrite: function (b, d) {
            ...
            d.find(c.linkSelector).each(function (b, c) {
              var d = a(c).is("[href]")
                ...
                g = a(c).attr(d);
              (g = g.replace(
                f.protocol + f.doubleSlash + f.host + f.pathname,
                ""
              )),
            ...
            this.options.role &&
              ...
              this.element.find("[" + c + "role='content']").each(function () {
                ...
                (d.options.contentTheme =
                  ...
                  ("dialog" === d.element.jqmData("role") && d.options.theme)),
                  e.addClass("ui-content"),
                  d.options.contentTheme &&
                    e.addClass("ui-body-" + d.options.contentTheme),
      ...
      a.widget("mobile.pagecontainer", {
        ...
        load: function (b, c) {
          ...
          return (
            k.data &&
              "get" === k.type &&
              ((m = a.mobile.path.addSearchParams(m, k.data)), (k.data = d)),
                ...
                l.length && !k.reload
                  ...
                  : ((h = {
                    ...
                    g.event.isDefaultPrevented()
                      ? i.promise()
                      : (k.showLoadMsg && this._showLoading(k.loadMsgDelay),
                        k.prefetch === d && this._getBase().reset(),
                        a.mobile.allowCrossDomainPages ||
                        a.mobile.path.isSameDomain(a.mobile.path.documentUrl, m)
                          ? (a.ajax({
                              url: e,
                              type: k.type,
                              data: k.data,
        ...
        _triggerPageBeforeChange: function (b, c, d) {
          ...
          return (
            ...
            (c.absUrl =
              "string" === a.type(b)
                ? a.mobile.path.makeUrlAbsolute(b, this._findBaseWithDefault())
                : d.absUrl),
          ...
          if (
            ...
            try {
              ...
              "body" !== c.activeElement.nodeName.toLowerCase()
                ...
                : a("input:focus, textarea:focus, select:focus").blur();
            } catch (w) {}
            (r = !1),
              q &&
                m &&
              ...
              (s = m
                ? b.jqmData("title") ||
                  b.children(":jqmData(role='header')").find(".ui-title").text()
                : p),
              s && p === c.title && (p = s),
        ...
        (a.mobile._registerInternalEvents = function () {
          var c = function (b, c) {
            ...
            return !a.mobile.ajaxEnabled ||
              ...
              b.attr("target")
              ? !1
              : ((d = (j && j.attr("formaction")) || b.attr("action")),
                  ...
                  : (c ||
                      ...
                      j &&
                        ...
                        f &&
                          ...
                          f && e.push({ name: f, value: j.attr("value") }))),
                      (h = {
                        url: d,
                        options: {
                          type: g,
          ...
          a.mobile.document.delegate("form", "submit", function (b) {
              ...
              if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                if (((j = a(g)), a.data(g, "mobile-button"))) {
                  ...
                  if (
                    ...
                    !g ||
                      "#" ===
                        a.mobile.path.parseUrl(g.getAttribute("href") || "#")
                          .hash)
                  )
                    return;
                ...
                ~g.className.indexOf("ui-link-inherit")
                  ? g.parentNode && (f = a.data(g.parentNode, "buttonElements"))
            ...
            a.mobile.document.bind("click", function (c) {
              if (a.mobile.linkBindingEnabled && !c.isDefaultPrevented()) {
                ...
                if (
                  (a.mobile.activeClickedLink &&
                    a.mobile.activeClickedLink[0] === c.target.parentNode &&
                    p(),
                  ...
                  if (
                    ...
                    g = a.mobile.path.isPath(g)
                      ? a.mobile.path.makeUrlAbsolute(g, f)
                      : a.mobile.path.makeUrlAbsolute("#" + g, i.hrefNoHash);
                  }
                  if (
                    ((h =
                      o.is("[rel='external']") ||
                    ...
                    (j =
                      h ||
                      (a.mobile.path.isExternal(g) &&
                        !a.mobile.path.isPermittedCrossDomainRequest(i, g))))
                  )
                    return void p();
      ...
      (a.mobile.Transition = function () {
        ...
        a.extend(a.mobile.Transition.prototype, {
          ...
          cleanFrom: function () {
            this.$from
              .removeClass(
                a.mobile.activePageClass + " out in reverse " + this.name
              )
              .height("");
          },
        ...
        _setOptions: function (b) {
          ...
          b.corners !== c &&
            ...
            b.overlayTheme !== c &&
              ...
              ((f.overlayTheme = b.overlayTheme), this._handlePageBeforeShow()),
            b.closeBtnText !== c && ((d = f.closeBtn), (e = b.closeBtnText)),
          ...
          (b = "left" === b ? "left" : "right" === b ? "right" : "none"),
            "none" === b
              ...
              ? (e
                  ...
                  .addClass("ui-btn-" + b),
                c && e.text(c))
              : ((d = this._inner.find(":jqmData(role='header')").first()),
                (e = a("<a></a>", {
                  href: "#",
                  class:
        ...
        _handleVClickSubmit: function (b) {
          ...
          d.length &&
            ...
            (c["data-" + a.mobile.ns + "transition"] =
              (a.mobile.navigate.history.getActive() || {}).transition ||
              a.mobile.defaultDialogTransition),
      ...
      a.widget("mobile.collapsible", {
        ...
        _create: function () {
              ...
              accordion: b
                .closest(
                  ":jqmData(role='collapsible-set'),:jqmData(role='collapsibleset')" +
                    (a.mobile.collapsibleset ? ", :mobile-collapsibleset" : "")
                )
          ...
          (this._ui = c),
            ...
            this.options.enhanced
              ? ((c.heading = this.element.children(".ui-collapsible-heading")),
        ...
        _getOptions: function (b) {
          ...
          (b = a.extend({}, b)),
            e.length &&
              !f &&
              (this._ui.accordionWidget = f = e.data("mobile-collapsibleset"));
          for (d in b)
            (b[d] =
              null != b[d]
                ? b[d]
                ...
                ? f.options[d]
                : e.length
                ? a.mobile.getAttribute(e[0], d.replace(c, "-$1").toLowerCase())
                : null),
        ...
        _enhance: function (b, c) {
          ...
          return (
            ...
            (c.content = b
              .wrapInner("<div class='ui-collapsible-content " + g + "'></div>")
            ...
            (c.anchor = c.heading
              ...
              .addClass(
                "ui-btn " +
                  (e ? e + " " : "") +
                  (e ? d(f.iconpos) + " " : "") +
                  this._themeClassFromOption("ui-btn-", f.theme) +
                  " " +
                  (f.mini ? "ui-mini " : "")
              )),
        ...
        _applyOptions: function (a) {
          ...
          a.collapsed !== b && this._handleExpandCollapse(a.collapsed),
            ...
            c
              ...
              : n.collapseCueText !== b && m.text(n.collapseCueText),
            (h =
              n.collapsedIcon !== b
                ? n.collapsedIcon !== !1
                : j.collapsedIcon !== !1),
            (n.iconpos !== b ||
              ...
              (l.removeClass(
                [d(j.iconpos)]
                  .concat(j.expandedIcon ? ["ui-icon-" + j.expandedIcon] : [])
            ...
            n.theme !== b &&
              ((f = this._themeClassFromOption("ui-btn-", j.theme)),
              (e = this._themeClassFromOption("ui-btn-", n.theme)),
              l.removeClass(f).addClass(e)),
            n.contentTheme !== b &&
              ((f = this._themeClassFromOption("ui-body-", j.contentTheme)),
              ...
              return (
                f &&
                  e
                    ...
                    .addClass(f),
                a.inset !== b &&
                  (d = !(!a.inset || (!a.corners && !this.options.corners))),
                a.corners !== b &&
                  (d = !(!a.corners || (!a.inset && !this.options.inset))),
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              (b += a.options.inset ? " ui-listview-inset" : ""),
                a.options.inset &&
                  ((b += a.options.corners ? " ui-corner-all" : ""),
            ...
            refresh: function (c) {
              ...
              for (
                x.theme && y.addClass("ui-group-theme-" + x.theme),
                  z &&
                    (A || 0 === A) &&
                    ((n = parseInt(A, 10) - 1),
                ...
                (g = w.eq(e)),
                  ...
                  (c ||
                    ...
                    ((l = this._getChildrenByTagName(g[0], "a", "A")),
                    (m = "list-divider" === b(g[0], "role")),
                    (p = g.attr("value")),
                    (i = b(g[0], "theme")),
                    l.length && l[0].className.search(/\bui-btn\b/) < 0 && !m
                      ? ((j = b(g[0], "icon")),
                        (k = j === !1 ? !1 : j || x.icon),
                        ...
                        l.length > 1
                          ? ((h = "ui-li-has-alt"),
                            ...
                            q
                              .attr("title", a.trim(q.getEncodedText()))
                              .addClass(u)
                              .empty(),
                            (l = l.first()))
                          : k && (d += " ui-btn-icon-right ui-icon-" + k),
                        l.addClass(d))
                      : m
                      ? ((v = b(g[0], "theme") || x.dividerTheme || x.theme),
                        (h = "ui-li-divider ui-bar-" + (v ? v : "inherit")),
                        g.attr("role", "heading"))
                      : l.length <= 0 &&
                        (h = "ui-li-static ui-body-" + (i ? i : "inherit")),
                    z &&
                      p &&
                      ((o = parseInt(p, 10) - 1),
        ...
        a.extend(
          {
            ...
            _create: function () {
              var b = this.element,
                ...
                e = this.options.enhanced
                  ? { element: this.element.siblings("label"), isParent: !1 }
                  : this._findLabel(),
                f = b[0].type,
                g = "ui-" + f + "-on",
                h = "ui-" + f + "-off";
              ("checkbox" === f || "radio" === f) &&
                ...
                (c.iconpos =
                  d(b, "iconpos") ||
                  e.element.attr("data-" + a.mobile.ns + "iconpos") ||
                  c.iconpos),
            ...
            _findLabel: function () {
              ...
              return (
                g && g.length > 0
                  ? ((d = a(g[0])), (e = a.contains(d[0], f[0])))
                  : ((b = f.closest("label")),
                    (e = b.length > 0),
                    (d = e
                      ? b
                      : a(this.document[0].getElementsByTagName("label"))
                          .filter("[for='" + c(f[0].id) + "']")
                          .first())),
            ...
            _handleLabelVClick: function (a) {
              ...
              return b.is(":disabled")
                ...
                : (this._cacheVals(),
                  b.prop(
                    "checked",
                    ("radio" === this.inputtype && !0) || !b.prop("checked")
                  ),
            ...
            _updateAll: function (b) {
              ...
              this._getInputSet()
                .each(function () {
                  var d = a(this);
                  (!this.checked && "checkbox" !== c.inputtype) ||
                    b ||
                    d.trigger("change");
                })
            ...
            _hasIcon: function () {
              ...
              return d &&
                ((b = this.element.closest(
                  ":mobile-controlgroup," + d.prototype.initSelector
                )),
                b.length > 0)
            ...
            refresh: function () {
              ...
              this._hasIcon()
                ...
                b
                  ? (e.push(this.checkedClass), f.push(this.uncheckedClass))
                  : (e.push(this.uncheckedClass), f.push(this.checkedClass)),
                this.widget().toggleClass(
                  "ui-state-disabled",
            ...
            _setOptions: function (a) {
              ...
              a.disabled !== b &&
                ...
                a.wrapperClass !== b &&
                  e.removeClass(d.wrapperClass).addClass(a.wrapperClass),
                a.iconpos !== b && f
                  ? c
                      .removeClass("ui-btn-icon-" + d.iconpos)
    ...
    (function (a, b) {
      a.widget("mobile.button", {
        ...
        _setOptions: function (c) {
          var d = this.widget();
          c.theme !== b &&
            d.removeClass(this.options.theme).addClass("ui-btn-" + c.theme),
            ...
            (c.icon !== b || c.iconshadow !== b || c.iconpos !== b) &&
              d
                .removeClass(this._getIconClasses(this.options))
                .addClass(this._getIconClasses(a.extend({}, this.options, c))),
            this._super(c);
        },
        refresh: function (b) {
          var c,
          ...
          this.options.icon &&
            ...
            this.options.disabled !== d && this._setOptions({ disabled: d });
        },
      });
    })(a),
    (function (a) {
      ...
      a.widget("mobile.textinput", {
        ...
        _classesFromOptions: function () {
          var a = this.options,
            b = [];
          return (
            b.push("ui-body-" + (null === a.theme ? "inherit" : a.theme)),
        ...
        a.extend(
          {
            ...
            _create: function () {
              ...
              p.addClass(v ? "ui-slider-switch" : "ui-slider-input"),
                ...
                this._on(H.add(c), { vmouseup: "_sliderVMouseUp" }),
                H.insertAfter(p),
                v ||
                  w ||
                  ((f = this.options.mini
            ...
            refresh: function (b, d, e) {
              ...
              if (
                ...
                this.options.highlight &&
                  ...
                  (this.valuebg = (function () {
                    var b = c.createElement("div");
                    return (
                      (b.className = "ui-slider-bg " + a.mobile.activeBtnClass),
                ...
                null == b &&
                  (b = m ? parseFloat(l.val() || 0) : l[0].selectedIndex),
              ...
              if (
                ...
                this._labels &&
                  ((v = (this.handle.width() / this.slider.width()) * 100),
                  (w = k && v + ((100 - v) * k) / 100),
            ...
            _setHighlight: function (a) {
              (a = !!a),
                a
                  ...
                  : this.valuebg &&
                    (this.valuebg.remove(), (this.valuebg = !1));
            },
        ...
        a.extend(
          {
            ...
            _enhance: function () {
              ...
              f
                ...
                b
                  .addClass(
                    "ui-flipswitch ui-shadow-inset ui-bar-" +
                      e +
                      " " +
                      (c.wrapperClass ? c.wrapperClass : "") +
                      " " +
                      (d.is(":checked") ||
                      d.find("option").eq(1).is(":selected")
                ...
                a.extend(this, { flipswitch: b, on: f, off: g, type: h });
            },
            _reset: function () {
              this.refresh();
            },
        ...
        a.extend(
          {
            ...
            _slidedrag: function (b) {
              ...
              return (
                ...
                ("first" === this._proxy && c) || ("last" === this._proxy && !c)
            ...
            _change: function (b) {
              ...
              return (
                ...
                d === e
                  ? (a.data(g.get(0), "mobile-slider").handle.css("z-index", 1),
                    a.data(h.get(0), "mobile-slider").handle.css("z-index", 0))
                  : (a
            ...
            _updateHighlight: function () {
              var b = parseInt(
                  a.data(this._inputFirst.get(0), "mobile-slider").handle.get(0)
                    .style.left,
                  10
                ),
                c = parseInt(
                  a.data(this._inputLast.get(0), "mobile-slider").handle.get(0)
                    .style.left,
                  10
                ),
                d = c - b;
      ...
      a.widget("mobile.textinput", a.mobile.textinput, {
        ...
        _setOptions: function (a) {
          this._super(a),
            ...
            a.clearBtnText !== b &&
              this._clearBtn !== b &&
              this._clearBtn.text(a.clearBtnText).attr("title", a.clearBtnText);
        },
        ...
        a.extend(
          {
              ...
              a.length > 0 &&
                (a.is(".ui-btn-left, .ui-btn-right") &&
                  this.element.addClass(
                    a.hasClass("ui-btn-left") ? "ui-btn-left" : "ui-btn-right"
                  ),
                    ...
                    "ui-btn" +
                      (d.icon
                        ? " ui-icon-" +
                          ...
                          " ui-btn-icon-" +
                          e +
                          (d.iconshadow ? " ui-shadow-icon" : "")
                        : "") +
                      (d.theme ? " ui-btn-" + d.theme : "") +
              ...
              this.setButtonText(),
                ...
                this.isMultiple &&
                  (this.buttonCount = a("<span>")
                    ...
                    .hide()
                    .appendTo(f.addClass("ui-li-has-count"))),
            ...
            setButtonCount: function () {
              var a = this.selected();
              this.isMultiple &&
                this.buttonCount[a.length > 1 ? "show" : "hide"]().text(
                  a.length
                );
            },
      ...
      a.widget("mobile.popup", {
        ...
        _create: function () {
          var b = this.element,
            ...
            d = this.options;
          (d.history =
            d.history && a.mobile.ajaxEnabled && a.mobile.hashListeningEnabled),
        ...
        _enhance: function (b, c) {
            ...
            f = {
              screen: a(
                "<div class='ui-screen-hidden ui-popup-screen " +
                  this._themeClassFromOption("ui-overlay-", d.overlayTheme) +
                  "'></div>"
              ),
              placeholder: a(
          ...
          return (
            ...
            b
              ...
              .addClass(
                "ui-popup " +
                  this._themeClassFromOption("ui-body-", d.theme) +
                  " " +
        ...
        _setOptions: function (a) {
          ...
          return (
            ...
            a.overlayTheme !== c &&
              (e
                .removeClass(
                  this._themeClassFromOption("ui-overlay-", b.overlayTheme)
                )
                .addClass(
                  this._themeClassFromOption("ui-overlay-", a.overlayTheme)
                ),
            ...
            a.transition !== c &&
              (this._currentTransition || this._applyTransition(a.transition)),
        ...
        _openPrerequisitesComplete: function () {
          ...
          this._ui.container.addClass("ui-popup-active"),
            (this._isOpen = !0),
            this._resizeScreen(),
            a.contains(this._ui.container[0], this.document[0].activeElement) ||
              this._safelyBlur(this.document[0].activeElement),
            c.length > 0 && (this._ui.focusElement = c),
            this._ignoreResizeEvents(),
            b &&
              this.document
                .find("[aria-haspopup='true'][aria-owns='" + b + "']")
        ...
        _closePrerequisitesDone: function () {
          ...
          (a.mobile.popup.active = c),
            ...
            d &&
              this.document
                .find("[aria-haspopup='true'][aria-owns='" + d + "']")
              ...
              j.history
                ? ((h = a.mobile.navigate.history),
                  ...
                  (g = c.indexOf(d) > -1 && !f && h.activeIndex > 0)
                    ? (i._open(b), i._bindContainerClose(), this)
                    : (-1 !== c.indexOf(d) || f
    ...
    (function (a, b) {
      var d =
        ...
        e = function (a, b, c) {
          ...
          e.length &&
            (b.blur().attr("tabindex", "-1"), e.find("a").first().focus());
        };
      a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            ...
            (("vclick" === b.type ||
              ...
              "overlay" === this.menuType
                ? this.button
                    ...
                    .attr("data-" + (a.mobile.ns || "") + "rel", "popup")
                : this.button
                    .attr("href", "#" + this.dialogId)
                    .attr("data-" + (a.mobile.ns || "") + "rel", "dialog"),
              (this.isOpen = !0)));
        },
        ...
        build: function () {
          ...
          return v.nativeMenu
            ...
            : ((c = this.selectId),
              ...
              (i = c + "-menu"),
              (j = v.theme
                ? " data-" + a.mobile.ns + "theme='" + v.theme + "'"
                : ""),
              (k = v.overlayTheme || v.theme || null),
              (l = k
                ? " data-" + a.mobile.ns + "overlay-theme='" + k + "'"
                : ""),
              (m =
                v.dividerTheme && h
                  ? " data-" +
              ...
              (o = a(
                "<div" + j + l + " id='" + d + "' class='ui-selectmenu'></div>"
              )
                  ...
                  a.inArray(b, d) > -1
                    ? (e.attr("aria-selected", !0),
                      c.isMultiple
                        ...
                        ? e.next().find("a").addClass(a.mobile.activeBtnClass)
                        : e.find("a").addClass(a.mobile.activeBtnClass))
                    : c.isMultiple &&
                      e
                        .find("a")
        ...
        close: function () {
          if (!this.options.disabled && this.isOpen) {
            var a = this;
            "page" === a.menuType
              ? (a.menuPage.dialog("close"), a.list.appendTo(a.listbox))
        ...
        _buildList: function () {
          var b,
            ...
            B = !1;
          for (
            q.list.empty().filter(".ui-listview").listview("destroy"),
            ...
            (h = b[g]),
              ...
              i.hasClass("ui-screen-hidden") ||
                ...
                this.isMultiple &&
                  a(l).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"),
                p.appendChild(l),
                A.appendChild(p));
    ...
    (function (a, b) {
      function c(a, b) {
        ...
        return (
          ...
          a.icon &&
            ((c = c.concat(["ui-icon-" + a.icon, "ui-btn-icon-" + a.iconpos])),
        ...
        for (a = a.split(" "), c = 0; c < a.length; c++)
          (e = !0),
            ...
            d !== b
              ...
              ? ((e = !1), (h = !1), (i.iconpos = a[c].substring(12)))
        ...
        a.extend(
          {
              ...
              a.fn.buttonMarkup &&
                ...
                a.each(
                  ...
                  a.proxy(function (b, c) {
                    a.mobile[c] &&
                      this.element.find(a.mobile[c].initSelector).not(d)[c]();
                  }, this)
                ),
                a.extend(this, { _ui: null, _initialRefresh: !0 }),
                (this._ui = c.enhanced
                  ? {
                      groupLegend: b
            ...
            _enhance: function () {
                  ...
                  childWrapper: b
                    .addClass(
                      "ui-controlgroup ui-controlgroup-" +
                        ("horizontal" === c.type ? "horizontal" : "vertical") +
                        " " +
              ...
              return (
                d.groupLegend.length > 0 &&
                  a("<div role='heading' class='ui-controlgroup-label'></div>")
              ...
              return (
                a.type !== b &&
                  (e
                    ...
                    .addClass(
                      "ui-controlgroup-" +
                        ("horizontal" === a.type ? "horizontal" : "vertical")
                    ),
                  (c = !0)),
                a.theme !== b &&
                  e
            ...
            refresh: function () {
              ...
              a.mobile.checkboxradio &&
                b.find(":mobile-checkboxradio").checkboxradio("refresh"),
                this._addFirstLastClasses(
                  c,
                  this.options.excludeInvisible ? this._getVisibles(c, d) : c,
                  d
                ),
      ...
      a.widget("mobile.toolbar", {
        ...
        _create: function () {
          ...
          0 === e.length &&
            ...
            a.extend(this, { role: d, page: e, leftbtn: b, rightbtn: c }),
            this.element
              .attr("role", "header" === d ? "banner" : "contentinfo")
              .addClass("ui-" + d),
            this.refresh(),
        ...
        _addHeaderButtonClasses: function () {
          ...
          (this.leftbtn =
            a.hasClass("ui-btn-left") && !a.hasClass("ui-toolbar-back-btn")),
            ...
            (this.rightbtn =
              this.rightbtn || a.eq(1).addClass("ui-btn-right").length);
        },
      ...
      a.widget("mobile.toolbar", a.mobile.toolbar, {
            ...
            c.fullscreen !== b &&
              (c.fullscreen
                ? (this.element.addClass("ui-" + this.role + "-fullscreen"),
                  d.addClass("ui-page-" + this.role + "-fullscreen"))
            ...
            h.trackPersistentToolbars &&
              ...
              (f =
                (d.length &&
                  c.nextPage &&
                  a(
                    ".ui-footer-fixed:jqmData(id='" + d.jqmData("id") + "')",
                    c.nextPage
                  )) ||
                a()),
              (g =
                (e.length &&
                  c.nextPage &&
                  a(
                    ".ui-header-fixed:jqmData(id='" + e.jqmData("id") + "')",
                    c.nextPage
                  )) ||
                a()),
              (f.length || g.length) &&
        ...
        updatePagePadding: function (c) {
          ...
          this.options.fullscreen ||
            ((c =
              (c && c.type === b && c) || this.page || d.closest(".ui-page")),
        ...
        _useTransition: function (b) {
          ...
          return (
            ...
            ((this.options.transition &&
              ...
              (("header" === this.role && !this.options.fullscreen && e > f) ||
                ("footer" === this.role &&
                  !this.options.fullscreen &&
                  g - f > e + h))) ||
              this.options.fullscreen)
        ...
        _bindToggleHandlers: function () {
          ...
          g.bind("vclick", function (b) {
            ...
            screen.width < 1025 &&
              ...
              !a(g.target).closest(".ui-header-fixed, .ui-footer-fixed")
                .length &&
              ("focusout" !== g.type || f
                ? "focusin" === g.type &&
                  f &&
    ...
    (function (a) {
      a.widget("mobile.toolbar", a.mobile.toolbar, {
        ...
        _viewportOffset: function () {
          ...
          return (
            b ||
              (c = Math.round(c - this.window.height() + a.outerHeight()) - 60),
            c
          );
        },
      ...
      a.widget("mobile.popup", a.mobile.popup, {
        ...
        _create: function () {
          var a,
            b = this._super();
          return (
            this.options.arrow && (this._ui.arrow = a = this._addArrow()), b
          );
        },
        _addArrow: function () {
          var a,
        ...
        _setOptions: function (a) {
          ...
          return (
            ...
            e &&
              (a.theme !== b &&
                ((d = this._themeClassFromOption("ui-body-", d)),
                (c = this._themeClassFromOption("ui-body-", a.theme)),
                e.ar.removeClass(d).addClass(c)),
              a.shadow !== b &&
                e.ar.toggleClass("ui-overlay-shadow", a.shadow)),
            f
          );
        },
        _destroy: function () {
      ...
      a.widget("mobile.panel", {
        ...
        _positionPanel: function (b) {
          ...
          e || !c.options.positionFixed
            ? (e && (c._unfixPanel(), a.mobile.resetActivePageHeight(d)),
              b && this.window[0].scrollTo(0, a.mobile.defaultHomeScroll))
            : c._fixPanel();
        },
          ...
          if (!this._open) {
            var c = this,
              ...
              f = function () {
                c._open &&
                  ("overlay" !== d.display &&
                    (c._wrapper.addClass(d.classes.pageContentPrefix + "-open"),
                    c
                      ._fixedToolbars()
                      .addClass(d.classes.pageContentPrefix + "-open")),
                  c._bindFixListener(),
                  c._trigger("open"),
            ...
            var c = this,
              ...
              e = function () {
                c.element.removeClass(d.classes.panelOpen),
                  "overlay" !== d.display &&
                    (c._wrapper.removeClass(c._pageContentOpenClasses),
                  ...
                  !b && a.support.cssTransform3d && d.animate
                    ...
                    : setTimeout(f, 0),
                  c._modal &&
                    c._modal.removeClass(c._modalOpenClasses).height("");
              },
              f = function () {
                d.theme &&
                  "overlay" !== d.display &&
                  ...
                  "overlay" !== d.display &&
                    (c._page().parent().removeClass(d.classes.pageContainer),
                    c._wrapper.removeClass(
                      d.classes.pageContentPrefix + "-open"
                    ),
                    c
                      ._fixedToolbars()
                      .removeClass(d.classes.pageContentPrefix + "-open")),
                  a.support.cssTransform3d &&
                    d.animate &&
                    "overlay" !== d.display &&
                    (c._wrapper.removeClass(d.classes.animate),
        ...
        _destroy: function () {
          ...
          "overlay" !== c.display &&
            ...
            this._open &&
              ...
              a.support.cssTransform3d &&
                c.animate &&
                this._fixedToolbars().removeClass(c.classes.animate),
            ...
            c.each(function () {
              ...
              a(this)
                ...
                .each(function () {
                  ...
                  a(this).jqmData(
                    "cells",
                    b.find("tr").not(c.eq(0)).not(this).children(g)
                  ),
                    d++;
                });
            });
      ...
      a.widget("mobile.table", a.mobile.table, {
                ...
                (b = (c
                  ...
                  : a(
                      "<label><input type='checkbox' checked />" +
                        (i.children("abbr").first().attr("title") || i.text()) +
                        "</label>"
                    )
                      .appendTo(g)
                      .children(0)
                      .checkboxradio({ theme: f.columnPopupTheme })
                )
                  .jqmData("header", i)
                  .jqmData("cells", h)),
                i.jqmData("input", b));
        ...
        _enhanceColToggle: function () {
          ...
          return (
            ...
            (d = a(
              "<div class='" + g.classes.popup + "' id='" + b + "'></div>"
            )),
      ...
      a.widget("mobile.table", a.mobile.table, {
        ...
        _updateReflow: function () {
          ...
          a(b.allHeaders.get().reverse()).each(function () {
            ...
            i.length > 0 &&
              (h
                ? ((d = parseInt(this.getAttribute("colspan"), 10)),
                  (e = ""),
                  d && (e = "td:nth-child(" + d + "n + " + g + ")"),
                  b._addLabels(f.filter(e), c.classes.cellLabels + h, i))
    ...
    (function (a, c) {
      var d = function (b, c) {
        return (
          -1 ===
          ("" + (a.mobile.getAttribute(this, "filtertext") || a(this).text()))
            .toLowerCase()
            .indexOf(c)
        );
      };
      ...
      (a.mobile.filterable.prototype.options.filterCallback = function (a, b) {
        ...
        a.widget("mobile.filterable", a.mobile.filterable, {
          ...
          _handleCreate: function (a) {
            this._setWidget(
              this.element.data(
                "mobile-" + a.type.substring(0, a.type.length - 6)
              )
            );
          },
          ...
          _setOptions: function (c) {
            ...
            return (
              ...
              c.filterTheme !== b &&
                this._search &&
                a.mobile.textinput &&
                this._search.textinput("option", "theme", c.filterTheme),
              d
            );
          },
          _refreshChildWidget: function () {
          ...
          _syncTextInputOptions: function (c) {
            ...
            if (this._isSearchInternal() && a.mobile.textinput) {
              for (d in a.mobile.textinput.prototype.options)
                c[d] !== b &&
                  (e[d] =
                    "theme" === d && null != this.options.filterTheme
        ...
        _processTabs: function () {
          ...
          (this.tablist = this._getList()
            ...
            this.anchors.each(function (c, e) {
              ...
              d(e)
                ? ((f = e.hash), (g = b.element.find(b._sanitizeSelector(f))))
                : ((h = b._tabId(j)),
                  (f = "#" + h),
                  (g = b.element.find(f)),
                  g.length ||
          ...
          a.extend(a.mobile, {
            initializePage: function () {
              ...
              f.length ||
                ...
                f.each(function () {
                  var c = a(this);
                  c[0].getAttribute("data-" + a.mobile.ns + "url") ||
                    c.attr(
                      "data-" + a.mobile.ns + "url",
                      c.attr("id") ||
                        b.convertUrlToDataUrl(i.pathname + i.search)
                    );
                }),
